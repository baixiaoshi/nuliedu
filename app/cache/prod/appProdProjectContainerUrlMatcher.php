...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/qrcode') && preg_match('#^/qrcode/(?P<text>[\\w\\W]+)/(?P<extension>jpg|png|gif)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'endroid_qrcode')), array (  '_controller' => 'Endroid\\QrCode\\Bundle\\Controller\\QrCodeController::generateAction',  '_permission' => '',));
        }
        ...
        if (0 === strpos($pathinfo, '/oauth2/login')) {
            ...
            if ($pathinfo === '/oauth2/login/main') {
                return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::mainAction',  '_route' => 'oauth2_login_index',  '_permission' =>   array (  ),);
            }

            // oauth2_login_app
            if ($pathinfo === '/oauth2/login/app') {
                return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::appAction',  '_route' => 'oauth2_login_app',  '_permission' =>   array (  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/oauth2/login/bind_')) {
                ...
                if ($pathinfo === '/oauth2/login/bind_account') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::bindAccountAction',  '_route' => 'oauth2_login_bind_account',  '_permission' =>   array (  ),);
                }
                not_oauth2_login_bind_account:

                // oauth2_login_bind_login
                if ($pathinfo === '/oauth2/login/bind_login') {
                    return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::bindLoginAction',  '_route' => 'oauth2_login_bind_login',  '_permission' =>   array (  ),);
                }
            ...
            if ($pathinfo === '/oauth2/login/create') {
                return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::createAction',  '_route' => 'oauth2_login_create',  '_permission' =>   array (  ),);
            }

            // oauth2_login_success
            if ($pathinfo === '/oauth2/login/success') {
                return array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\LoginController::successAction',  '_route' => 'oauth2_login_success',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/hls')) {
            ...
            if (preg_match('#^/hls/(?P<id>[^/]++)/playlist/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_playlist')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::playlistAction',  '_permission' =>   array (  ),));
            }

            // hls_audio_playlist
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/playlist/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_playlist')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::playlistAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/hls')) {
            ...
            if (preg_match('#^/hls/(?P<id>[^/]++)/stream/(?P<level>[^/]++)/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_stream')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::streamAction',  '_permission' =>   array (  ),));
            }

            // hls_audio_stream
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/stream/(?P<level>[^/]++)/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_stream')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::streamAction',  '_permission' =>   array (  ),));
            }

            // hls_clef
            if (preg_match('#^/hls/(?P<id>[^/]++)/clef/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_clef')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::clefAction',  '_permission' =>   array (  ),));
            }

            // hls_audio_clef
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/clef/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_clef')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::clefAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/order')) {
            ...
            if (preg_match('#^/order/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'order_detail')), array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::detailAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/order/(?P<orderId>[^/]++)/cancel_refund$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'order_cancel_refund')), array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderRefundController::cancelRefundAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/settings')) {
            ...
            if ($pathinfo === '/settings/profile/avatar/crop/modal') {
                return array (  '_controller' => 'AppBundle\\Controller\\SettingsController::profileAvatarCropModalAction',  '_route' => 'settings_profile_avatar_crop_modal',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/my')) {
            if (0 === strpos($pathinfo, '/my/teaching')) {
                ...
                if ($pathinfo === '/my/teaching/live/calendar') {
                    return array (  '_controller' => 'AppBundle\\Controller\\My\\CourseSetController::teachingLivesCalendarAction',  '_route' => 'my_teaching_live_calendar',  '_permission' =>   array (  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/my/order')) {
                ...
                if (0 === strpos($pathinfo, '/my/order_refund')) {
                    ...
                    if ($pathinfo === '/my/order_refunds') {
                        return array (  '_controller' => 'AppBundle\\Controller\\My\\OrderRefundController::indexAction',  '_route' => 'my_order_refunds',  '_permission' =>   array (  ),);
                    }

                    // my_order_refund_detail
                    if (preg_match('#^/my/order_refund/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_order_refund_detail')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderRefundController::detailAction',  '_permission' =>   array (  ),));
                    }

                    // my_order_refund_apply
                    if (preg_match('#^/my/order_refund/(?P<id>[^/]++)/apply$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_order_refund_apply')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderRefundController::applyRefundAction',  '_permission' =>   array (  ),));
                    }
            ...
            if ($pathinfo === '/my/income_records') {
                return array (  '_controller' => 'AppBundle:My/MoneyRecord:index',  '_route' => 'income_records',  '_permission' =>   array (  ),);
            }

            // payout_records
            if ($pathinfo === '/my/payout_records') {
                return array (  '_controller' => 'AppBundle:My/MoneyRecord:payout',  '_route' => 'payout_records',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/cashier')) {
            ...
            if ($pathinfo === '/cashier/standard') {
                return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::showAction',  '_route' => 'cashier_show',  '_permission' =>   array (  ),);
            }

            // cashier_redirect
            if ($pathinfo === '/cashier/redirect') {
                return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::redirectAction',  '_route' => 'cashier_redirect',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/pay/center/wxpay')) {
            ...
            if ($pathinfo === '/pay/center/wxpay') {
                return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\WechatController::wechatJsPayAction',  '_route' => 'cashier_wechat_js_pay',  '_permission' =>   array (  ),);
            }

            // cashier_wechat_mweb_app_trade
            if ($pathinfo === '/pay/center/wxpay_mweb_app_trade') {
                return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\WechatController::wechatAppMwebTradeAction',  '_route' => 'cashier_wechat_mweb_app_trade',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/ca')) {
            if (0 === strpos($pathinfo, '/cashier')) {
                ...
                if ($pathinfo === '/cashier/password/check') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::checkPayPasswordAction',  '_route' => 'cashier_password_check',  '_permission' =>   array (  ),);
                }
                ...
                if (preg_match('#^/cashier/(?P<sn>[^/]++)/price$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_price')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::priceAction',  '_permission' =>   array (  ),));
                }
                not_cashier_pay_price:

                // cashier_pay_success
                if ($pathinfo === '/cashier/pay/success') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::successAction',  '_route' => 'cashier_pay_success',  '_permission' =>   array (  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/callback')) {
                ...
                if (preg_match('#^/callback/(?P<payment>[^/]++)/notify$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_notify')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::notifyAction',  '_permission' =>   array (  ),));
                }
                not_cashier_pay_notify:

                // cashier_pay_return_for_app
                if (preg_match('#^/callback/(?P<payment>[^/]++)/return_for_app$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_return_for_app')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::returnForAppAction',  '_permission' =>   array (  ),));
                }

                // cashier_pay_return
                if (preg_match('#^/callback/(?P<payment>[^/]++)/return$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_return')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::returnAction',  '_permission' =>   array (  ),));
                }
        ...
        if (0 === strpos($pathinfo, '/pay')) {
            if (0 === strpos($pathinfo, '/pay/center')) {
                ...
                if ($pathinfo === '/pay/center/auth_unbind') {
                    ...
                    return array (  '_controller' => 'AppBundle:PayCenter:unbindAuth',  '_route' => 'pay_center_auth_unbind',  '_permission' =>   array (  ),);
                }
                not_pay_center_auth_unbind:

                // auth_unbind_mobile_show
                if ($pathinfo === '/pay/center/mobile_show') {
                    return array (  '_controller' => 'AppBundle:PayCenter:showMobile',  '_route' => 'auth_unbind_mobile_show',  '_permission' =>   array (  ),);
                }

                if (0 === strpos($pathinfo, '/pay/center/pay')) {
                    // pay_return
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/return$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_return')), array (  '_controller' => 'AppBundle:PayCenter:payReturn',  '_permission' =>   array (  ),));
                    }

                    // pay_return_for_app
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/return_for_app$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_return_for_app')), array (  '_controller' => 'AppBundle:PayCenter:payReturnForApp',  '_permission' =>   array (  ),));
                    }

                    // pay_notify
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/notify$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_notify')), array (  '_controller' => 'AppBundle:PayCenter:payNotify',  '_permission' =>   array (  ),));
                    }
                ...
                if ($pathinfo === '/pay/center/success/show') {
                    return array (  '_controller' => 'AppBundle:PayCenter:showTarget',  '_route' => 'pay_success_show',  '_permission' =>   array (  ),);
                }
            ...
            if ($pathinfo === '/pay/password/check') {
                return array (  '_controller' => 'AppBundle:PayCenter:payPasswordCheck',  '_route' => 'pay_password_check',  '_permission' =>   array (  ),);
            }

            // pay_error
            if ($pathinfo === '/pay/error') {
                return array (  '_controller' => 'AppBundle:PayCenter:payError',  '_route' => 'pay_error',  '_permission' =>   array (  ),);
            }

            // pay_result_notice
            if ($pathinfo === '/pay/result/notice') {
                return array (  '_controller' => 'AppBundle:PayCenter:resultNotice',  '_route' => 'pay_result_notice',  '_permission' =>   array (  ),);
            }

            // wxpay_roll
            if ($pathinfo === '/pay/wxpay/roll') {
                return array (  '_controller' => 'AppBundle:PayCenter:wxpayRoll',  '_route' => 'wxpay_roll',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/order')) {
            ...
            if ($pathinfo === '/order/show') {
                return array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::showAction',  '_route' => 'order_show',  '_permission' =>   array (  ),);
            }
            ...
            if ($pathinfo === '/order/create') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::createAction',  '_route' => 'order_create',  '_permission' =>   array (  ),);
            }
            not_order_create:
        ...
        if (0 === strpos($pathinfo, '/settings/find_pay_password_by_')) {
            ...
            if ($pathinfo === '/settings/find_pay_password_by_question') {
                return array (  '_controller' => 'AppBundle\\Controller\\SettingsController::findPayPasswordByQuestionAction',  '_route' => 'settings_find_pay_password_by_question',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/learn/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_learn_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::learnDataDetailAction',  '_permission' =>   array (  ),));
            }

            // course_manage_student_learn_detail_modal
            if (preg_match('#^/course/(?P<courseId>[^/]++)/student/(?P<userId>[^/]++)/learn/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_student_learn_detail_modal')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::studentDataDetailModalAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/plugin/task_list/paging$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_show_plugin_task_list_by_paging')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::taskListByPagingAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/overview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_overview')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::overviewAction',  '_permission' =>   array (  ),));
                }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_task_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::taskDetailListAction',  '_permission' =>   array (  ),));
            }

            // course_set_manage_student_detail
            if (preg_match('#^/course/(?P<courseId>[^/]++)/student/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_student_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::studentDetailAction',  '_permission' =>   array (  ),));
            }
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/trendency$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_trendency')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::trendencyAction',  '_permission' =>   array (  ),));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/(?P<type>[^/]++)/records$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_records')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::studentRecordsAction',  '_permission' =>   array (  ),));
                }
                ...
                if (0 === strpos($pathinfo, '/my/courses')) {
                    if (0 === strpos($pathinfo, '/my/courses/l')) {
                        ...
                        if ($pathinfo === '/my/courses/live/calendar') {
                            return array (  '_controller' => 'AppBundle\\Controller\\My\\CourseController::learningLivesCalendarAction',  '_route' => 'my_courses_live_calendar',  '_permission' =>   array (  ),);
                        }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if ($pathinfo === '/course/show_exit_modal') {
                return array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::exitModalAction',  '_route' => 'course_exit_modal',  '_permission' =>   array (  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)/retry_transcode$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_retry_transcode')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::retryTranscodeAction',  '_permission' =>   array (  ),));
                }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/activity/(?P<activityId>[^/]++)/exam/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_exam_next_result_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultNextCheckAction',  '_permission' =>   array (  ),));
            }

            // course_manage_testpaper_result_graph
            if (preg_match('#^/course/(?P<id>[^/]++)/activity/(?P<activityId>[^/]++)/testpaper/graph$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_result_graph')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultGraphAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/exam/activity/(?P<activityId>[^/]++)/analysis$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_exam_result_anlysis')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultAnalysisAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/classroom')) {
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/record/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_record')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::recordAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/exam/activity/(?P<activityId>[^/]++)/analysis$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_exam_result_anlysis')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultAnalysisAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/activity/(?P<activityId>[^/]++)/exam/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_exam_next_result_check')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultNextCheckAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/activity/(?P<activityId>[^/]++)/testpaper/graph$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_testpaper_result_graph')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultGraphAction',  '_permission' =>   array (  ),));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/buy$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_buy')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomBuyController::buyAction',  '_permission' =>   array (  ),));
            }
            not_classroom_buy:
        ...
        if (0 === strpos($pathinfo, '/global_file')) {
            ...
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/player$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_document_player')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::globalDocumentPlayerAction',  '_permission' =>   array (  ),));
            }
        ...
        if ($pathinfo === '/coupon/check') {
            return array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::couponCheckAction',  '_route' => 'coupon_check',  '_permission' =>   array (  ),);
        }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/buy$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_buy')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseBuyController::buyAction',  '_permission' =>   array (  ),));
            }
            not_course_buy:
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/tasks/paging$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_paging_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::tasksByPagingAction',  '_permission' =>   array (  ),));
            }
        ...
        if (0 === strpos($pathinfo, '/marketing/user/login')) {
            ...
            if ($pathinfo === '/marketing/user/login') {
                return array (  '_controller' => 'AppBundle\\Controller\\MarketingUserController::loginAction',  '_route' => 'marketing_user_login',  '_permission' =>   array (  ),);
            }

            // user_login_marketing
            if ($pathinfo === '/marketing/user/login') {
                return array (  '_controller' => 'AppBundle\\Controller\\MarketingUserController::loginAction',  '_route' => 'user_login_marketing',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/export') && preg_match('#^/export/(?P<name>[^/]++)(?:/(?P<type>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::exportAction',  'type' => 'csv',  '_permission' =>   array (  ),));
        }

        // online_sample
        if ($pathinfo === '/online/sample') {
            return array (  '_controller' => 'AppBundle\\Controller\\OnlineController::sampleAction',  '_route' => 'online_sample',  '_permission' =>   array (  ),);
        }

        // pre_export
        if (0 === strpos($pathinfo, '/pre/export') && preg_match('#^/pre/export/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'pre_export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::preExportAction',  '_permission' =>   array (  ),));
        }

        // try_export
        if (0 === strpos($pathinfo, '/try/export') && preg_match('#^/try/export/(?P<name>[^/]++)(?:/(?P<limit>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'try_export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::tryExportAction',  'limit' => '',  '_permission' =>   array (  ),));
        }
        ...
        if (0 === strpos($pathinfo, '/member') && preg_match('#^/member/(?P<operatType>[^/]++)/record/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'member_operation_record')), array (  '_controller' => 'AppBundle\\Controller\\MemberOperationRecordController::showRecordAction',  '_permission' =>   array (  ),));
        }

        if (0 === strpos($pathinfo, '/v2/demo')) {
            // v2_demo
            if ($pathinfo === '/v2/demo') {
                return array (  '_controller' => 'AppBundle\\Controller\\V2Controller::demoAction',  '_route' => 'v2_demo',  '_permission' =>   array (  ),);
            }

            // v2_demo_modal
            if ($pathinfo === '/v2/demo/modal') {
                return array (  '_controller' => 'AppBundle\\Controller\\V2Controller::modalAction',  '_route' => 'v2_demo_modal',  '_permission' =>   array (  ),);
            }
        ...
        if ($pathinfo === '/order/price/calculate') {
            return array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::priceAction',  'limit' => '',  '_route' => 'order_calculate_price',  '_permission' =>   array (  ),);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/course_set')) {
                ...
                if (preg_match('#^/admin/course_set/(?P<id>[^/]++)/course/list$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_list')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::courseListAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),));
                }
                ...
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone_by_web$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone_by_web')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneByWebAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),));
                }
                ...
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone_by_crontab$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone_by_crontab')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneByCrontabAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),));
                }
                ...
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneAction',  'type' => 'web',  '_permission' =>   array (    0 => 'admin_course_manage',  ),));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/course')) {
                ...
                if (0 === strpos($pathinfo, '/admin/courses/data') && preg_match('#^/admin/courses/data/(?P<courseSetId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_courses_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::coursesDataAction',  '_permission' =>   array (    0 => 'admin_course_set_data',  ),));
                }
            ...
            if ($pathinfo === '/admin/order/manage') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderController::manageAction',  '_route' => 'admin_order_manage',  '_permission' =>   array (    0 => 'admin_order_manage',  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/order')) {
                ...
                if (preg_match('#^/admin/order/(?P<id>[^/]++)/adjust_price$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_adjust_price')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderController::adjustPriceAction',  '_permission' =>   array (    0 => 'admin_finance',  ),));
                }

                if (0 === strpos($pathinfo, '/admin/order/refund')) {
                    // admin_order_refunds
                    if ($pathinfo === '/admin/order/refunds') {
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderRefundController::refundsAction',  '_route' => 'admin_order_refunds',  '_permission' =>   array (    0 => 'admin_finance',  ),);
                    }

                    // admin_order_refund_detail
                    if (preg_match('#^/admin/order/refund/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_refund_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderRefundController::refundDetailAction',  '_permission' =>   array (    0 => 'admin_finance',  ),));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/setting/site')) {
                ...
                if ($pathinfo === '/admin/setting/site/save') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\SiteSettingController::saveSiteAction',  '_route' => 'admin_setting_site_save',  '_permission' =>   array (    0 => 'admin_setting_message',  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                if (0 === strpos($pathinfo, '/admin/setting/cloud')) {
                    ...
                    if ($pathinfo === '/admin/setting/cloud/normal/video/delete') {
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\EduCloudController::deleteVideoAction',  '_route' => 'admin_cloud_normal_video_delete',  '_permission' =>   array (  ),);
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/theme')) {
                ...
                if ($pathinfo === '/admin/theme/config/save') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::saveConfigAction',  '_route' => 'admin_save_themes_config',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),);
                }
                ...
                if ($pathinfo === '/admin/theme/show') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::showAction',  '_route' => 'admin_themes_show',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),);
                }

                // admin_themes_config_edit
                if ($pathinfo === '/admin/theme/config/edit') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::themeConfigEditAction',  '_route' => 'admin_themes_config_edit',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/invite')) {
                ...
                if ($pathinfo === '/admin/invite') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\InviteController::userRecordsAction',  '_route' => 'admin_invite',  '_permission' =>   array (    0 => 'admin_operation_invite',  ),);
                }

                // admin_invite_record
                if ($pathinfo === '/admin/invite/record') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\InviteController::recordAction',  '_route' => 'admin_invite_record',  '_permission' =>   array (    0 => 'admin_operation_invite',  ),);
                }
            ...
            if ($pathinfo === '/admin/coin/records') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\CoinController::recordsAction',  '_route' => 'admin_coin_records',  '_permission' =>   array (  ),);
            }

            // admin_order_manage_export_csv
            if ($pathinfo === '/admin/order/manage/export') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderController::exportCsvAction',  '_route' => 'admin_order_manage_export_csv',  '_permission' =>   array (  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/cloud/edulive') && preg_match('#^/admin/cloud/edulive/(?P<type>[^/]++)/logo/crop$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_edulive_logo_crop')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\EduCloudController::logoCropAction',  '_permission' =>   array (  ),));
            }
            ...
            if ($pathinfo === '/admin/login/marketing') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\MarketingController::loginMarketingAction',  '_route' => 'admin_login_marketing',  '_permission' =>   array (  ),);
            }

            if (0 === strpos($pathinfo, '/admin/job')) {
                // admin_jobs
                if ($pathinfo === '/admin/jobs') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::indexAction',  '_route' => 'admin_jobs',  '_permission' =>   array (    0 => 'admin_jobs',  ),);
                }

                // admin_job_logs
                if ($pathinfo === '/admin/job/logs') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::logsAction',  '_route' => 'admin_job_logs',  '_permission' =>   array (    0 => 'admin_job_logs',  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/crontab')) {
                ...
                if ($pathinfo === '/admin/crontab') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\CrontabController::indexAction',  '_route' => 'admin_crontab',  '_permission' =>   array (    0 => 'admin_crontab',  ),);
                }
                ...
                if ($pathinfo === '/admin/crontab/restore') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\CrontabController::restoreAction',  '_route' => 'admin_crontab_resotre',  '_permission' =>   array (  ),);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/job')) {
                ...
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/enabled$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_enabled')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::enabledAction',  '_permission' =>   array (  ),));
                }
                ...
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/disabled$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_disabled')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::disabledAction',  '_permission' =>   array (  ),));
                }
                not_admin_job_disabled:

                // admin_job_fires
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/fires$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_fires')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::firesAction',  '_permission' =>   array (  ),));
                }

                // admin_job_fired_logs
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/fire/(?P<jobFiredId>[^/]++)/logs$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_fired_logs')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::fireLogsAction',  '_permission' =>   array (  ),));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/xapi/s')) {
                ...
                if ($pathinfo === '/admin/xapi/setting') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\XapiController::settingAction',  '_route' => 'admin_xapi_setting',  '_permission' =>   array (    0 => 'admin_xapi_setting',  ),);
                }

                if (0 === strpos($pathinfo, '/admin/xapi/statement')) {
                    // admin_xapi_statement_list
                    if ($pathinfo === '/admin/xapi/statement_list') {
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\XapiController::indexAction',  '_route' => 'admin_xapi_statement_list',  '_permission' =>   array (    0 => 'admin_xapi_statement_list',  ),);
                    }

                    // admin_xapi_statement_detail
                    if (preg_match('#^/admin/xapi/statement/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_xapi_statement_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\XapiController::detailAction',  '_permission' =>   array (  ),));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/c')) {
                if (0 === strpos($pathinfo, '/admin/course')) {
                    ...
                    if (preg_match('#^/admin/course/(?P<courseId>[^/]++)/datas/export/prepare$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_task_data_export_prepare')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::prepareForExportTasksDatasAction',  '_permission' =>   array (    0 => 'admin_course_set_data',  ),));
                    }

                    // admin_course_task_data_export
                    if (preg_match('#^/admin/course/(?P<courseId>[^/]++)/datas/export$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_task_data_export')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::exportTaskDatasAction',  '_permission' =>   array (  ),));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/sms/prepare') && preg_match('#^/admin/sms/prepare/(?P<targetType>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sms_prepare')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SmsController::prepareAction',  '_permission' =>   array (  ),));
            }

            // publish_sms_send
            if (0 === strpos($pathinfo, '/admin/publish/sms_send') && preg_match('#^/admin/publish/sms_send/(?P<targetType>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'publish_sms_send')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SmsController::sendAction',  '_permission' =>   array (  ),));
            }

            // generate_short_link
            if ($pathinfo === '/admin/generate/short/link') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\SmsController::changeLinkAction',  '_route' => 'generate_short_link',  '_permission' =>   array (  ),);
            }

            if (0 === strpos($pathinfo, '/admin/queue/failed_log')) {
                // admin_queue_failed_logs
                if ($pathinfo === '/admin/queue/failed_logs') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\QueueController::failedJobsAction',  '_route' => 'admin_queue_failed_logs',  '_permission' =>   array (    0 => 'admin_queue_failed_logs',  ),);
                }

                // admin_queue_failed_log_modal
                if (preg_match('#^/admin/queue/failed_log/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_queue_failed_log_modal')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\QueueController::failedJobAction',  '_permission' =>   array (  ),));
                }
            ...
            if ($pathinfo === '/admin/online') {
                return array (  '_controller' => 'AppBundle\\Controller\\OnlineController::indexAction',  '_route' => 'admin_online',  '_permission' =>   array (    0 => 'admin_online',  ),);
            }

            // admin_bill
            if (0 === strpos($pathinfo, '/admin/bill') && preg_match('#^/admin/bill/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_bill')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BillController::billAction',  '_permission' =>   array (  ),));
            }

            if (0 === strpos($pathinfo, '/admin/user/learn')) {
                // admin_user_learn_statistics
                if ($pathinfo === '/admin/user/learn/statistics') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::showAction',  '_route' => 'admin_user_learn_statistics',  '_permission' =>   array (    0 => 'admin_user_learn_statistics',  ),);
                }

                // admin_user_learn_detail
                if (preg_match('#^/admin/user/learn/(?P<userId>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_learn_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::detailAction',  '_permission' =>   array (  ),));
                }

                // admin_user_learn_chart
                if (preg_match('#^/admin/user/learn/(?P<userId>[^/]++)/chart$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_learn_chart')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::learnChartAction',  '_permission' =>   array (  ),));
                }

                // admin_user_learn_statistics_info
                if ($pathinfo === '/admin/user/learn/statistics/info') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::syncInfoAction',  '_route' => 'admin_user_learn_statistics_info',  '_permission' =>   array (  ),);
                }

            }

            if (0 === strpos($pathinfo, '/admin/data/lab')) {
                // admin_cloud_data_lab
                if ($pathinfo === '/admin/data/lab') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DataLabController::dataAction',  '_route' => 'admin_cloud_data_lab',  '_permission' =>   array (    0 => 'admin_cloud_data_lab',  ),);
                }

                if (0 === strpos($pathinfo, '/admin/data/lab/setting')) {
                    // admin_cloud_data_lab_setting
                    if ($pathinfo === '/admin/data/lab/setting') {
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DataLabController::setttingAction',  '_route' => 'admin_cloud_data_lab_setting',  '_permission' =>   array (    0 => 'admin_cloud_data_lab_setting',  ),);
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/data/lab/setting/modal')) {
                        ...
                        if ($pathinfo === '/admin/data/lab/setting/modal/enable') {
                            return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DataLabController::enableXapiSettingAction',  '_route' => 'admin_cloud_data_lab_setting_enable_modal',  '_permission' =>   array (  ),);
                        }

                        // admin_cloud_data_lab_setting_disable_modal
                        if ($pathinfo === '/admin/data/lab/setting/modal/disable') {
                            return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DataLabController::disableXapiSettingAction',  '_route' => 'admin_cloud_data_lab_setting_disable_modal',  '_permission' =>   array (  ),);
                        }
