...
class __TwigTemplate_424b5a8928d4059158387d872419c473ae2e97c791014c032340f130f4d7576d extends Twig_Template
{
        ...
        echo "
            ...
            <li>
                <a href=\"#task-data-detail\" data-toggle=\"tab\">
                    ";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.dashboard.task_detail"), "html", null, true);
        echo "
                </a>
            </li>
        </ul>
...
";
    ...
    {
        return new Twig_Source("", "course-manage/overview/task-detail.htm.twig", "/vagrant_data/nuliedu/app/Resources/views/course-manage/overview/task-detail.htm.twig");
    }
}
