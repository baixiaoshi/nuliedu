...
class __TwigTemplate_f9dbad673dcd4b3cc3407d6cd92dfcf164cc3bf92726ae28cc4742c9695cdd4e extends Twig_Template
{
    ...
    {
        // line 6
        $context["appDownload"] = ((( !((array_key_exists("custom", $context)) ? (_twig_default_filter(($context["custom"] ?? null), 0)) : (0)) && $this->env->getExtension('AppBundle\Twig\WebExtension')->isESCopyright()) && $this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("mobile.enabled", null)) && $this->env->getExtension('AppBundle\Twig\WebExtension')->isShowMobilePage());
        // line 7
  ...
  ";
    ...
    {
        return new Twig_Source("", "default/base-index.html.twig", "/vagrant_data/nuliedu/app/Resources/views/default/base-index.html.twig");
    }
}
