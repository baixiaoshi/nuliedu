...
class __TwigTemplate_526c9a70c2b2cae92dd3256e2925862dc6a0b30507537314a951d4b2c64967e0 extends Twig_Template
{
      ...
      <ul class=\"form-group task-create-type-list \">
        ...
        if ($asm89CacheBody1 === false) {
            ob_start();
                ...
                data-content-url=\"";
                        // line 20
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_manage_task_fields", array("courseId" => $this->getAttribute(($context["course"] ?? null), "id", array()), "mode" => "create", "type" => $context["type"])), "html", null, true);
                        echo "\">
              <a href=\"javascript:;\" ";
                        // line 21
                        if ((($context["mode"] ?? null) == "edit")) {
        ...
        // line 33
        echo twig_escape_filter($this->env, ((array_key_exists("chapterId", $context)) ? (_twig_default_filter(($context["chapterId"] ?? null), null)) : (null)), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  150 => 36,  146 => 35,  142 => 34,  138 => 33,  134 => 32,  130 => 31,  125 => 29,  122 => 28,  115 => 27,  104 => 23,  100 => 22,  94 => 21,  90 => 20,  86 => 19,  79 => 18,  73 => 17,  67 => 16,  62 => 13,  56 => 12,  54 => 11,  50 => 10,  46 => 9,  41 => 8,  39 => 7,  34 => 6,  31 => 5,  27 => 1,  25 => 3,  11 => 1,);
    }
    ...
    {
        return new Twig_Source("", "task-manage/modal.html.twig", "/vagrant_data/nuliedu/app/Resources/views/task-manage/modal.html.twig");
    }
}
